package com.sundsoft.model.db.dt;

import java.util.Date;

public class UtbDkMarginDetialsVo {
	...
	private int calinttype;
	private String calintdate;
	private String remark;
	private String lasteditdate;
	private String lasteditopt;
	private Date sysdat;
	...
	public void setCalinttype(int calinttype) {
		this.calinttype = calinttype;
	}
	...
	public void setLasteditopt(String lasteditopt) {
		this.lasteditopt = lasteditopt;
	}
	...
	public void setVerifyopt(String verifyopt) {
		this.verifyopt = verifyopt;
	}
	...
	public void setBzjlx(int bzjlx) {
		this.bzjlx = bzjlx;
	}

	public void setZqlx(int zqlx) {
		this.zqlx = zqlx;
	}
