...
public class DtExchangeServiceImpl implements IDtExchangeService {
	...
	@Override
	public String DT_GB101(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		...
		try {
			...
			ResponseUtil.err("E400", e.getMessage());
		}
		return ResponseUtil.succ();
	}

	@Override
	public String DT_GB102(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
	...
	@Override
	public String DT_GB201(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
	...
	@Override
	public String DT_GB202(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
	...
	@Override
	public String DT_GB203(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
	...
	@Override
	public String DT_GB204(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
	...
	@Override
	public String DT_GB301(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
	...
	@Override
	public String DT_GB302(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
	...
	@Override
	public String DT_GB303(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
	...
	@Override
	public String DT_GB304(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
	...
	@Override
	public String DT_GB305(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
	...
	@Override
	public String DT_GB306(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
	...
	@Override
	public String DT_DK_LPXM_V5(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
	...
	@Override
	public String DT_DK_LPXMMX_V5(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
	...
	@Override
	public String DT_DK_KFS_V5(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
	...
	@Override
	public String DT_DK_DKJD_V5(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
	...
	@Override
	public String DT_GB202EXT(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
	...
	@Override
	public String DT_MARGIN_MAIN(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
	...
	@Override
	public String DT_MARGIN_DETIALS(VisitControl v_Control, List<Map<String, Object>> p_Data) {
		if(p_Data==null||p_Data.size()==0){
