...
public class BMSExchangeServiceImpl implements IBMSExchangeServices {
	...
	public String loanApply(String accname) {
		return "hello " + accname;
	}
	...
	@Override
	public String QueryBalanceCallBack(String seqno, int state, String info, String acctBal, String acctRestBal, String acctOverBal,
			String acctStatus) {
		String m_ErrorInfo = null;
		try {
			...
			resMap = exchangeService.CallbackQueBalance(seqno, state, info, m_AcctBal, m_AcctRestBal, m_AcctOverBal, acctStatus);
